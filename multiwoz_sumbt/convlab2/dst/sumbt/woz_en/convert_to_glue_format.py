...
def convert_to_glue_format(args):
 ...
 #   ontology = ontology["informable"]
  #  ontology
    ...
    target_slots = ['informable-area', 'informable-food', 'informable-pricerange', 'request-address', 'request-area', 'request-food', 'request-name', 'request-phone', 'request-postcode', 'request-pricerange']
